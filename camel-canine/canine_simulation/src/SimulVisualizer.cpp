...
void SimulVisualizer::UpdateFootStep()
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        mLocalFootPosBox[i]->setPosition(sharedMemory->visualPosition[i][0], sharedMemory->visualPosition[i][1], sharedMemory->visualPosition[i][2]);
    }
...
void SimulVisualizer::initRobotPose()
{
    ...
    initialJointPosition[3] = 0.5;
    initialJointPosition[6] = 0.5;
