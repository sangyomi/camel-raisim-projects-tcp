...
void serializeSharedMemoryInfo (QDataStream &stream)
{
    ...
    stream.writeRawData(reinterpret_cast<char*>(sharedMemory->motorVelocity), MOTOR_NUM * sizeof(double));
    ...
    stream.writeRawData(reinterpret_cast<char*>(sharedMemory->contactState), 4 * sizeof(double));

    stream.writeRawData(reinterpret_cast<char*>(sharedMemory->tempIMU), 3 * sizeof(double));
    ...
    // CUSTOM_DATA
    stream.writeRawData(reinterpret_cast<char*>(sharedCustom->customVariableDouble), MAX_COMMAND_DATA * sizeof(double));
    stream.writeRawData(reinterpret_cast<char*>(sharedCustom->customVariableInt), MAX_COMMAND_DATA * sizeof(int));
}
