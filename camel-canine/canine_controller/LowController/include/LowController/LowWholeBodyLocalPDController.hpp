...
#ifndef CAMEL_RAISIM_PROJECTS_LOWWHOLEBODYLOCALPDCONTROLLER_HPP
#define CAMEL_RAISIM_PROJECTS_LOWWHOLEBODYLOCALPDCONTROLLER_HPP
...
class LowWholeBodyLocalPDController{
public:
    LowWholeBodyLocalPDController();
...
//    CubicSwingLeg SwingLegTrajectory;
    ...
    Vec3<double> mShoulderFootPosition[4];
...
#endif //CAMEL_RAISIM_PROJECTS_LOWWHOLEBODYLOCALPDCONTROLLER_HPP
