...
//    CubicTrajectoryGenerator mCubicFootTrajectoryGenerator[8];
//    CubicFullTrajectoryGenerator mCubicFullFootTrajectoryGenerator[4];
//    QuadTrajectoryGenerator mQuadFootTrajectoryGenerator[4];
